...
console.log(element1, element2); // fire water
...
console.log(firstStone, sixthStone); // exctracted stones 1 and 6
...
console.log(`The visble shadow: ${visibleShadow}, The hidden shadows: ${hiddenShadows}`);
...
function revealPath(distance,direction){
	console.log(`Move to  ${distance} meters towards ${direction}.`);

}
revealPath(100,"west")// function recall
...
castSpell(["air", "sand", "earth"]); // function recall
...
console.log(`the  stones sawp: ${stoneA}, ${stoneB}`);